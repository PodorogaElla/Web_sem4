...
$reynsla  = [
    ...
    [
        'job' => 'Инженер',
        'date' => '2019-2021г.г.',
        'description'=> 'Геолого-техническая разработка.'
    ],
    [
        'job' => 'Финансист',
        'date' => '2007-2019г.г.',
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
         ...
         <?php for ($i = 0; $i < count($reynsla); $i++):?>
           <div class="w3-container">
            <h5 class="w3-opacity"><b><?=$reynsla [$i] ['job'];?> </b></h5>
            <h6 class="w3-text-teal">
                <i class="fa fa-calendar fa-fw w3-margin-right"></i><?=$reynsla [$i] ['date'];?> 
            </h6>
            <p><?=$reynsla [$i] ['description'];?></p>
            <hr>
          </div>
          <?php endfor;?>
        </div>
